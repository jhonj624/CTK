...
void ctkSettingsDialogPrivate::init()
{
  ...
  this->SettingsButtonBox->button(QDialogButtonBox::Ok)->setToolTip(
    q->tr("Aplicar configuraciones y cerrar dialogo."));//Apply settings and close dialog."));
  this->SettingsButtonBox->button(QDialogButtonBox::Cancel)->setToolTip(
    q->tr("Rechazar los cambios de configuración y cerrar dialogo."));//Reject settings changes and close dialog."));
  this->SettingsButtonBox->button(QDialogButtonBox::Reset)->setToolTip(
    q->tr("Resetear configuraciones a sus valores cuando el dialogo abrió."));//Reset settings to their values when the dialog opened"));
  this->SettingsButtonBox->button(QDialogButtonBox::RestoreDefaults)->setToolTip(
    q->tr("Restaurar configuraciones a sus valores por defecto. ")); //Restore settings to their default values."
    //"Cancelar a \"Restaurar\", usted puede \"Resetear\" las configuraciones.")); //To cancel a \"Restore\", you can \"Reset\" the settings."));
    this->SettingsButtonBox->button(QDialogButtonBox::RestoreDefaults)->setText("Restaurar por defecto");
    this->SettingsButtonBox->button(QDialogButtonBox::Cancel)->setText("Cancelar");
...
void ctkSettingsDialogPrivate::updateRestartRequiredLabel()
{
  ...
  if (restartRequired)
    {
    QString header = q->tr(
      "<b style=\"color:red\">Requerido reiniciar!</b><br>\n<small>"
      "La aplicación debe ser reiniciada para tener en cuenta "
      "los nuevos valores de las siguientes propiedades:\n");
...
/*    QMessageBox::StandardButton answer = QMessageBox::question(this,"Restart required",
      ...
      QMessageBox::StandardButton answer = QMessageBox::question(this,"Requerido reiniciar",
        "Para que las configuraciones se tomen en cuenta, la aplicación\n"
        "debe ser reiniciada. ¿Reiniciar la aplicación ahora?\n",
        QMessageBox::Yes|QMessageBox::No|QMessageBox::Cancel, QMessageBox::No);
...
void ctkSettingsDialog::onDialogButtonClicked(QAbstractButton* button)
{
  ...
  switch (d->SettingsButtonBox->standardButton(button))
    ...
    case QDialogButtonBox::RestoreDefaults:
      if (QMessageBox::warning(this,"Restaurar todas las configuraciones",
            "¿Está seguro que quiere resetear\n"
            "todas las configuraciones a sus valores por defecto?\n",
...
void ctkSettingsDialog::setResetButton(bool show)
{
  ...
  d->SettingsButtonBox->button(QDialogButtonBox::Reset)->setText("Resetear");
}
